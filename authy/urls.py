...
from authy.views import UserProfile, Signup, PasswordChange, PasswordChangeDone, EditProfile, profile, index, post_detail, tag
...
urlpatterns = [
    ...
    path('profile/', post_detail, name='post_detail'),
    path('profile/', tag, name='tag'),
]
